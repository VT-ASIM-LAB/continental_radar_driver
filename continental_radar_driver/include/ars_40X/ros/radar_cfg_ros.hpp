...
namespace ars_40X
{
    class RadarCfgROS
    {
        public:
            ...
            bool set_max_distance(MaxDistance::Request &req, MaxDistance::Response &res);

            bool set_sensor_id(SensorID::Request &req, SensorID::Response &res);

            bool set_radar_power(RadarPower::Request &req, RadarPower::Response &res);

            bool set_output_type(OutputType::Request &req, OutputType::Response &res);

            bool set_send_quality(std_srvs::SetBool::Request &req,
                std_srvs::SetBool::Response &res);

            bool set_send_ext_info(std_srvs::SetBool::Request &req,
                std_srvs::SetBool::Response &res);

            bool set_sort_index(SortIndex::Request &req, SortIndex::Response &res);

            bool set_ctrl_relay_cfg(std_srvs::SetBool::Request &req,
                std_srvs::SetBool::Response &res);

            bool set_store_in_nvm(std_srvs::SetBool::Request &req,
                std_srvs::SetBool::Response &res);

            bool set_rcs_threshold(RCSThreshold::Request &req, RCSThreshold::Response &res);
