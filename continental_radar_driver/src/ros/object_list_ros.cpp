...
namespace ars_40X
{
    ObjectListROS::ObjectListROS(ros::NodeHandle &nh, ARS_40X_CAN *ars_40X_can) :
        ...
        objects_data_pub_ = nh.advertise<ars_40X::ObjectList>("objects", 10);
    }
    ...
    void ObjectListROS::send_object_2_quality() {
        ...
        object_list.objects[object_2_quality_id_].meas_state =
            object_2_quality_->get_object_meas_state();
    ...
    void ObjectListROS::send_object_3_extended() {
        object_list.objects[object_3_extended_id_].length =
            object_3_extended_->get_object_length();
        object_list.objects[object_3_extended_id_].width =
            object_3_extended_->get_object_width();
        object_list.objects[object_3_extended_id_].class_type =
