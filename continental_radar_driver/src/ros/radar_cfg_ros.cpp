...
namespace ars_40X
{
    RadarCfgROS::RadarCfgROS(ros::NodeHandle &nh, ARS_40X_CAN *ars_40X_can) :
        ...
        set_sensor_id_service_ =
            nh.advertiseService("set_sensor_id", &RadarCfgROS::set_sensor_id, this);
    ...
    bool RadarCfgROS::set_max_distance(MaxDistance::Request &req, MaxDistance::Response &res) {
    ...
    bool RadarCfgROS::set_sensor_id(SensorID::Request &req, SensorID::Response &res) {
    ...
    bool RadarCfgROS::set_radar_power(RadarPower::Request &req, RadarPower::Response &res) {
    ...
    bool RadarCfgROS::set_output_type(OutputType::Request &req, OutputType::Response &res) {
    ...
    bool RadarCfgROS::set_send_quality(std_srvs::SetBool::Request &req,
    ...
    bool RadarCfgROS::set_send_ext_info(std_srvs::SetBool::Request &req,
        std_srvs::SetBool::Response &res) {
    ...
    bool RadarCfgROS::set_sort_index(SortIndex::Request &req, SortIndex::Response &res) {
    ...
    bool RadarCfgROS::set_ctrl_relay_cfg(std_srvs::SetBool::Request &req,
        std_srvs::SetBool::Response &res) {
    ...
    bool RadarCfgROS::set_store_in_nvm(std_srvs::SetBool::Request &req,
        std_srvs::SetBool::Response &res) {
    ...
    bool RadarCfgROS::set_rcs_threshold(RCSThreshold::Request &req, RCSThreshold::Response &res) {
